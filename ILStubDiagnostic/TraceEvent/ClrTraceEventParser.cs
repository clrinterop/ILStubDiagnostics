...
{
    [Obsolete("Use ClrTraceEventParser")]
    public class CLRTraceEventParser : ClrTraceEventParser
    {
    ...
    public class ClrTraceEventParser : TraceEventParser
    {
        ...
        public event Action<ModuleLoadUnloadTraceData> LoaderModuleDCStart
        {
            ...
            {
                                                         // action, eventid, taskid, taskName, taskGuid, opcode, opcodeName, providerGuid, providerName
                source.RegisterEventTemplate(new ModuleLoadUnloadTraceData(value, 149, 10, "Loader", LoaderTaskGuid, 35, "ModuleDCStart", ProviderGuid, ProviderName));
            }
            remove
            {
                throw new Exception("Not supported");
        ...
        public event Action<ModuleLoadUnloadTraceData> LoaderModuleDCStop
        {
            ...
            {
                                                         // action, eventid, taskid, taskName, taskGuid, opcode, opcodeName, providerGuid, providerName
                source.RegisterEventTemplate(new ModuleLoadUnloadTraceData(value, 150, 10, "Loader", LoaderTaskGuid, 36, "ModuleDCStop", ProviderGuid, ProviderName));
            }
            remove
            {
                throw new Exception("Not supported");
       ...
       #region Event ID Definitions
        ...
        public const TraceEventID LoaderModuleDCStartEventID = (TraceEventID) 149;
        public const TraceEventID LoaderModuleDCStopEventID = (TraceEventID) 150;
    ...
    public sealed class RuntimeInformationTraceData : TraceEvent
    {
        ...
        protected internal override void Validate()
        {
            Debug.Assert(!(Version == 0 && EventDataLength != SkipUnicodeString(25)+16));
            Debug.Assert(!(Version > 0 && EventDataLength < SkipUnicodeString(25)+16));
        }
        public override StringBuilder ToXml(StringBuilder sb)
        {
        ...
        public override string[] PayloadNames
        {
            ...
            {
                if (payloadNames == null)
                    payloadNames = new string[] { "ClrInstanceID", "SKU", "BclMajorVersion", "BclMinorVersion", "BclBuildNumber", "BclQfeNumber", "VMMajorVersion", "VMMinorVersion", "VMBuildNumber", "VMQfeNumber", "StartupFlags", "StartupMode", "CommandLine", "ComObjectGUID"};
                return payloadNames;
            }
        }
